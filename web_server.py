...
def save_clip():
    ...
    """
    # If another save is already running, reject immediately
    ...
    try:
        ...
        filename      = os.path.join(VIDEO_DIR, f"{timestamp_str}_{device_id}_mag{mag:.1f}.avi")
        ...
        try:
          ...
          try:
              ...
              print(f"🗑️  Deleted video file: {metadata_file}")
          except Exception as e:
              print(f"⚠️  Could not delete file: {e}")
